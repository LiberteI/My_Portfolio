...
const thumbnailsDir = path.join(root, "public/images/project-thumbnails")
const outputDir = path.join(thumbnailsDir, "compressed-img")
...
const main = async () => {
    ...
    for (const job of jobs) {
        const inputPath = path.join(thumbnailsDir, job.input)
