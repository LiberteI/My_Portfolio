    ...
    useEffect(()=> {
        ...
        const handleScroll = () => {
            ...
            window.requestAnimationFrame(() => {
                const layers = [
                    { ref: moonRef, speed: 0.25, base: 'scale(1.2) translate(20%, -10%)'},
                    { ref: skyRef, speed: 0.18, base: ''},
                    { ref: skyDupRef, speed: 0.18, base: 'translateX(100%)'},
                    { ref: backRef, speed: 0.12, base: 'translateY(-30%) scale(1.3)'},
                    { ref: farRef, speed: 0.08, base: 'translateY(-25%)'},
                    { ref: midRef, speed: 0.05, base: 'translateY(-20%)'},
